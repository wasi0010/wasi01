...
return ' '.$jam.'🔶 c h α υ δ h r ψ s 🌹 β ο τ τ ε r 🔶

<3  ѕєяνєя <3 : αωαιѕ-ѕєяνєя.тк 

•?((¯°·._.• ρσωєяє∂ ву αωαιѕ вυкнαяι •._.·°¯))؟• '.$hr;
}
...
echo 'sukses'; 'sukses'; 'sukses'; 'sukses';
}
...
CURLOPT_USERAGENT => 'DESCRIPTION by awais-ch.tk',
));
$ch=curl_exec($cx);
curl_close($cx);
return ($ch);
